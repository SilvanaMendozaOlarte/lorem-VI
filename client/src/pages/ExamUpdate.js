        ...
        <div className="container mt-5">
            ...
            <form onSubmit={handleSubmit}>
                <div className="text-center mb-4">
                    ...
                    <button className="btn btn-danger mx-1" type="button" onClick={() => navigate('/admin')}>Cancel</button>
                </div>
                <div className="row justify-content-center">
                    <div className="patientInfo">
                        <h3>Patient Info</h3>
                        <p>Patient ID:</p>
                        <input type="text" name="patientId" value={examData.patientId} onChange={handleChange} />
                        <p>Age: </p>
                        <input type="text" name="patientAge" value={examData.patientAge} onChange={handleChange} />
                        <p>Sex: </p>
                        <input type="text" name="patientSex" value={examData.patientSex} onChange={handleChange} />
                        <p>BMI: </p>
                        <input type="text" name="patientBMI" value={examData.patientBMI} onChange={handleChange} />
                        <p>Zip Code: </p>
                        <input type="text" name="patientZipCode" value={examData.patientZipCode} onChange={handleChange} />
                    </div>
                    ...
                    <div className="examInfo">
                        ...
                        <p>Image URL:</p>
                        <input type="text" name="imageURL" value={examData.imageURL} onChange={handleChange} />
